    ...
    setTimeout(() => {
      const mockParsed: Array<AcademicAgendaItem & { selected: boolean }> = [
        ...
        },
        {
          ...
          description: 'Pengajian umum dan peringatan Maulid Nabi Muhammad SAW 1448 H.',
          selected: true,
        },
        {
          id: `ext-3-${Date.now()}`,
          title: 'Penilaian Tengah Semester (PTS) Ganjil T.A. 2026/2027',
          category: 'Kalender Akademik Sekolah',
          date: '2026-09-05',
          startTime: '07:30',
          endTime: '12:00',
          ...
          description: 'Pelaksanaan PTS Ganjil untuk siswa kelas 7, 8, dan 9 (5 - 12 September 2026).',
          selected: true,
        },
        {
          id: `ext-4-${Date.now()}`,
          title: 'Asesmen Nasional Berbasis Komputer (ANBK) Utama SMP',
          category: 'Kalender Akademik Sekolah',
          date: '2026-09-14',
          startTime: '07:30',
          endTime: '12:30',
        ...
        },
        {
          ...
          organizer: 'Panitia Ujian & Kurikulum SMP Darul Ulum',
          location: 'Ruang Ujian Sekolah',
          description: 'Ujian PAS Ganjil untuk siswa kelas 7, 8, dan 9 (7 - 14 Desember 2026).',
          selected: true,
        },
        {
          id: `ext-6-${Date.now()}`,
        ...
        },
        {
          ...
          organizer: 'Dinas Pendidikan Kota Surabaya & SMP Darul Ulum',
          location: 'Masjid & Kampus SMP Darul Ulum',
          description: 'Kegiatan permulaan puasa Ramadhan 1448 H (8 - 10 Februari 2027).',
          selected: true,
        },
        {
          id: `ext-12-${Date.now()}`,
