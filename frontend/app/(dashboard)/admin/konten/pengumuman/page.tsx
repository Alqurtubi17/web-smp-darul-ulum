...
const INITIAL_ANNOUNCEMENTS: AnnouncementItem[] = [
  ...
  {
    id: 'ann-3',
    title: 'Rapat Evaluasi Pembelajaran & Penyusunan Modul Ajar Kurikulum',
    content: 'Undangan rapat koordinasi dewan guru pada hari Senin, 24 Agustus 2026 jam 13.00 WIB bertempat di Ruang Guru Utama.',
    isPinned: false,
    targetRoles: ['GURU'],
  ...
  {
    id: 'ann-4',
    title: 'Pelaksanaan Latihan Ekstrakurikuler Wajib Pramuka & Kemah Sabtu-Minggu',
    content: 'Seluruh siswa kelas 7 wajib mengikuti kegiatan Perkemahan Sabtu Minggu (Persami) pada tanggal 29-30 Agustus 2026 di lapangan sekolah.',
    isPinned: false,
    targetRoles: ['SISWA'],
